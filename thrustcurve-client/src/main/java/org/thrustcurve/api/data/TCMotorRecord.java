...
public class TCMotorRecord {
	...
	private org.thrustcurve.api.xml.XmlTag record;
	
	private List<TCMotorData> data;
	
	public TCMotorRecord(org.thrustcurve.api.xml.XmlTag record) {
		this.record= record;
	...
	private String getValue(String key) {
		org.thrustcurve.api.xml.XmlTag tag = record.getChildren().getTag(key);
		if (tag == null) { return ""; }
		return tag.getValue();
	}
	 ...
	 * </pre>
	 */
	public void addData(org.thrustcurve.api.xml.XmlTag record) {
