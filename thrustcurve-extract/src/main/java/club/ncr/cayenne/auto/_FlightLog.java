...
public abstract class _FlightLog extends BaseDataObject {
    ...
    public static final Property<MotorMfg> MOTOR_MFG = Property.create("motorMfg", MotorMfg.class);
    ...
    public void setMotorMfg(MotorMfg motorMfg) {
        setToOneTarget("motorMfg", motorMfg, true);
    }

    public MotorMfg getMotorMfg() {
        return (MotorMfg)readProperty("motorMfg");
    }
